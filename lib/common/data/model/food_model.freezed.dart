...
abstract class $FoodModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? label, String? name, int? calorie, UnitEnum? unit});
}
...
class _$FoodModelImpl extends _FoodModel {
  const _$FoodModelImpl({this.label, this.name, this.calorie, this.unit})
      : super._();
  ...
  @override
  String toString() {
    return 'FoodModel(label: $label, name: $name, calorie: $calorie, unit: $unit)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, label, name, calorie, unit);
...
abstract class _FoodModel extends FoodModel {
  const factory _FoodModel(
      ...
      final String? name,
      final int? calorie,
      final UnitEnum? unit}) = _$FoodModelImpl;
